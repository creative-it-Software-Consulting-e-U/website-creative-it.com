      ...
      howItWorks: {
        ...
        features: [
          ...
          },
          {
            ...
            link: "/model-compare",
            whatItDoes:
              "Sends the same prompt to three model families on Amazon Bedrock — always the latest available generations of Claude Sonnet, Claude Haiku, and Amazon Nova Lite — and shows their answers side by side with latency, token usage, and approximate cost per call.",
            howItWorks:
      ...
      howItWorks: {
        ...
        features: [
          ...
          },
          {
            ...
            link: "/model-compare",
            whatItDoes:
              "Schickt denselben Prompt an drei Modellfamilien auf Amazon Bedrock — immer die neueste verfügbare Generation von Claude Sonnet, Claude Haiku und Amazon Nova Lite — und zeigt die Antworten nebeneinander mit Latenz, Token-Verbrauch und ungefähren Kosten pro Aufruf.",
            howItWorks:
